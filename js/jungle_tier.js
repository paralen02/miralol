$(document).ready(function() {
    ...
    $.ajax({
      ...
      success: function(data) {
        ...
        // Filter champions by role "JUNGLE"
        var jungleChampions = champions.filter(function(champion) {
          return champion.Role === 'JUNGLE';
        });
        ...
        tiers.forEach(function(tier) {
          groupedChampions[tier] = jungleChampions.filter(function(champion) {
