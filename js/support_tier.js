$(document).ready(function() {
    ...
    $.ajax({
      ...
      success: function(data) {
        ...
        // Filter champions by role "support"
        var supportChampions = champions.filter(function(champion) {
          return champion.Role === 'SUPPORT';
        });
        ...
        tiers.forEach(function(tier) {
          groupedChampions[tier] = supportChampions.filter(function(champion) {
