$(document).ready(function() {
    ...
    $.ajax({
      ...
      success: function(data) {
        ...
        // Filter champions by role "top"
        var topChampions = champions.filter(function(champion) {
          return champion.Role === 'TOP';
        });
        ...
        tiers.forEach(function(tier) {
          groupedChampions[tier] = topChampions.filter(function(champion) {
