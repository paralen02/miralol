$(document).ready(function() {
    ...
    $.ajax({
      ...
      success: function(data) {
        ...
        // Filter champions by role "mid"
        var midChampions = champions.filter(function(champion) {
          return champion.Role === 'MID';
        });
        ...
        tiers.forEach(function(tier) {
          groupedChampions[tier] = midChampions.filter(function(champion) {
